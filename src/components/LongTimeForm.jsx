...
function LongTimeForm({ id }) {
  ...
  return (
    <div
      id={id}
      className="scroll-mt-[130px] 2xl:max-w-[1440px] 2xl:px-0 mx-auto px-[25px] md:px-[60px] mt-[20px] md:mt-[60px] lg:mt-[100px] mb-[25px] md:mb-[45px]"
    >
      <form action="">
        <div className="grid grid-cols-1 lg:max-w-[55%] mx-auto w-full items-end gap-[15px] md:gap-[26px]">
          ...
          <div className="w-full font-dmsans">
            <label
              ...
              className="block text-sm md:text-base font-medium mb-2 text-white"
            >
          ...
          <div className="ddate">
            ...
            />
            <p className="font-monts text-[0.785em] md:text-sm mt-[15px] md:mt-[25px]">
