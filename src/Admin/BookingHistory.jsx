          ...
          <table className="w-full whitespace-nowrap ">
            ...
            <tbody className=" font-Cabin divide-y divide-gray-700/50 whitespace-nowrap">
              {TableData.map((data, index) => {
                const { carName, car, user, start, end, status } = data;
                return (
                  <tr className="text-gray-400 even:bg-gray-800 odd:bg-[#121317]">
                    ...
                    <td className="px-4 py-3 text-sm md:text-[16px]">{end}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center space-x-4 text-sm">
                        <Tooltip
                          ...
                          closeDelay="200"
                        >
                          <Link to="/dashboard/booking-history/history">
                            <Button
                              isIconOnly
                              size="sm"
